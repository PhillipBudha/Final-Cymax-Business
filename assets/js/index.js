document.addEventListener("DOMContentLoaded", function () {
  // Handling the dropdown toggle for nested menus
  ...
  dropdowns.forEach((dropdown) => {
    dropdown.addEventListener("click", function (e) {
      ...
      parentEl.querySelectorAll(".dropdown-menu").forEach((menu) => {
        if (menu !== nextEl) {
          menu.classList.remove("show");
        }
      });

      // Toggle the next dropdown
...
document.getElementById("acca-form").onclick = function () {
  window.location.href = "acca.html"; // Open in the same tab
};

document.getElementById("cgiz-form").onclick = function () {
  window.location.href = "cgiz.html"; // Modify to the correct URL if needed
};

document.getElementById("cont").onclick = function () {
  window.location.href = "student-dashboard.html"; // Modify to the correct URL if needed
};
