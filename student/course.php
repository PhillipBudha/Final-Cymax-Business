...
<!-- 
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-3 col-lg-2 d-none d-md-block sidebar">
                ...
                <div class="mb-4">
                    ...
                    <a href="../admin/assingment_tab/view_assingments.php" class="sidebar-link">
                        <i class="bi bi-mortarboard me-2"></i> Assingments
                    </a>
                    <a href="../admin/test/student_view.php" class="sidebar-link">
                        <i class="bi bi-pencil me-2"></i> Exams
                    </a>
                    <a href="../admin/quiz/student_view.php" class="sidebar-link">
                        <i class="bi bi-book me-2"></i> Quizes
                    </a>
                    <a href="../admin/online lessons/student_view.php" class="sidebar-link">
        ...
        <main class="col-md-9 col-lg-10 ms-sm-auto px-4 py-3">
              <img src="../assets/img/My-School-Portal-v3-1.png" alt="" class="full-image">
        </main>
