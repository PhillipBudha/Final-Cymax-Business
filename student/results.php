        ...
        <div class="row">
            <div class="col-md-3 col-lg-2 d-none d-md-block sidebar">
                ...
                <div class="mb-4">
                    ...
                    <a href="../admin/assingment_tab/results_assingments.php" class="sidebar-link">
                        <i class="bi bi-mortarboard me-2"></i> Assingments
                    </a>
                    <a href="../admin/assingment_tab/results_assingments.php" class="sidebar-link">
                        <i class="bi bi-pencil me-2"></i> Exams
                    </a>
                    <a href="../admin/quiz/student_results.php" class="sidebar-link">
                   ...
                   <!--  <a href="#" class="sidebar-link">
                    ...
                    <a href="profile.php" class="sidebar-link">
                        <i class="bi bi-newspaper me-2"></i> Transcipt
                    </a>
                    <a href="profile.php" class="sidebar-link">
